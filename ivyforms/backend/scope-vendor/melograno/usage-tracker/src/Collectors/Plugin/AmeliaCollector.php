...
use IvyForms\Vendor\Melograno\UsageTracker\Collectors\BaseCollector;
use IvyForms\Vendor\Melograno\UsageTracker\Collectors\ConsentNoticeCollectorInterface;
...
class AmeliaCollector extends BaseCollector implements ConsentNoticeCollectorInterface
{
    ...
    {
        return \IvyForms\Vendor\AmeliaBooking\Infrastructure\Licence\Licence::isPremium();
    }
    ...
    {
        $licence = \IvyForms\Vendor\AmeliaBooking\Infrastructure\Licence\Licence::getLicence();

        return is_string($licence)
            && strcasecmp($licence, \IvyForms\Vendor\AmeliaBooking\Infrastructure\Licence\LicenceConstants::LITE) === 0;
    }
    ...
    public function getConsentNoticePresentation(): array
    {
        return [
            ...
            'iconAlt' => 'Amelia',
            'title' => \IvyForms\Vendor\AmeliaBooking\Infrastructure\WP\Translations\BackendStrings::get('improve_amelia'),
            'description' => \IvyForms\Vendor\AmeliaBooking\Infrastructure\WP\Translations\BackendStrings::get('usage_tracking_description'),
            'enableLabel' => \IvyForms\Vendor\AmeliaBooking\Infrastructure\WP\Translations\BackendStrings::get('improve_plugin'),
            'learnMoreLabel' => \IvyForms\Vendor\AmeliaBooking\Infrastructure\WP\Translations\BackendStrings::get('learn_more'),
